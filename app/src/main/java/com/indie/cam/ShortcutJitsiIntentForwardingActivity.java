 ...
 */
public class ShortcutJitsiIntentForwardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL JitsiserverURL;
        try {
            JitsiserverURL = new URL("https://beta.meet.jit.si/moderated/");
